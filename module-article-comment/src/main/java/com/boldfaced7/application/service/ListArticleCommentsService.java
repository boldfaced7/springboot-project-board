...
import com.boldfaced7.application.port.in.ListArticleCommentsQuery;
...
public class ListArticleCommentsService implements ListArticleCommentsQuery {
    ...
    @Override
    public List<ResolvedArticleComment> listArticleComments(ListArticleCommentsCommand command) {
    ...
    private List<ArticleComment> getArticleComments(ListArticleCommentsCommand command) {
