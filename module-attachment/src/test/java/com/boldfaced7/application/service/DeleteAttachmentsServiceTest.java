...
class DeleteAttachmentsServiceTest {
    ...
    void givenDeleteAttachmentsCommand_whenDeleting_thenReturnsSavedArticle() {
        ...
        var sut = new DeleteAttachmentsService(
                ids -> dummy,
                attachments -> attachments
        );
        var command = new DeleteAttachmentsCommand(List.of(ID), MEMBER_ID);
    ...
    void givenWrongMemberId_whenDeleting_thenThrowsException() {
        ...
        var command = new DeleteAttachmentsCommand(List.of(ID), WRONG_MEMBER_ID);
