...
import com.boldfaced7.application.port.in.UpdateArticleTicketEventUseCase;
...
public class UpdateArticleTicketEventService implements UpdateArticleTicketEventUseCase {
    ...
    @Override
    public ArticleTicketEvent updateDisplayName(UpdateArticleTicketEventCommand command) {
