...
public class ServiceMethod {
    ...
    public static final BiFunction<ArticleService, Pageable, CustomPage<ArticleDto>> getArticles = ArticleService::getArticles;
    public static final BiFunction<ArticleService, MemberDto, CustomPage<ArticleDto>> getArticlesOfMember = ArticleService::getArticles;
    ...
    public static final BiFunction<ArticleCommentService, Pageable, CustomPage<ArticleCommentDto>> getArticleComments = ArticleCommentService::getArticleComments;
    public static final BiFunction<ArticleCommentService, ArticleDto, CustomPage<ArticleCommentDto>> getArticleCommentsOfArticle = ArticleCommentService::getArticleComments;
    public static final BiFunction<ArticleCommentService, MemberDto, CustomPage<ArticleCommentDto>> getArticleCommentsOfMember = ArticleCommentService::getArticleComments;
    ...
    public static final BiFunction<MemberService, Pageable, CustomPage<MemberDto>> getMembers = MemberService::getMembers;
